 ...
 */
public final class TreeMapHook {

    private static final String CLASS_NAME = "java.util.TreeMap";
    ...
    private static void forceEmptyItem(@NonNull final ClassLoader classLoader) {
        XposedHelpers.findAndHookMethod(CLASS_NAME, classLoader, "get", Object.class, new XTools_MethodHook() {
            @Override
            protected void afterHookedMethod(MethodHookParam param) throws Throwable {
                if (!isHook(param)) return;
